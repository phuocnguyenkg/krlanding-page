    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container max-w-8xl mx-auto px-5 2xl:px-0 relative z-10">
        <div className="grid grid-cols-12 gap-10">
          <div className="lg:col-span-6 mt-4 col-span-12 row-span-2">
            ...
            <p className="text-dark/50 dark:text-white/50 text-lg lg:max-w-full leading-[1.3] md:max-w-3/4">
              ...
              cao cấp, tọa lạc tại vị trí đắc địa trên đường Võ Văn Kiệt, phường
              An Hải Tây, quận Sơn Trà, thành phố Đà Nẵng.
              <br />
              <br />
              <strong>Thông tin chi tiết dự án:</strong>
              <br />• Tên dự án: The Legend Da Nang
              <br />• Chủ đầu tư: ROX Signature
              <br />• Vị trí: A20 Võ Văn Kiệt, Phường An Hải Tây, Quận Sơn Trà,
              TP. Đà Nẵng
              <br />• Đơn vị vận hành (Tòa khách sạn): Accor Hotels (theo tiêu
              chuẩn 5 sao quốc tế)
              <br />• Tên pháp lý: Tổ hợp Trung tâm thương mại – Khách sạn – Căn
              hộ cao cấp
              <br />
              <br />
              ...
              khu vui chơi trẻ em, trung tâm thương mại, nhà hàng, quán cà phê,…
              đáp ứng mọi nhu cầu sinh hoạt và giải trí của cư dân.
            </p>
          </div>
